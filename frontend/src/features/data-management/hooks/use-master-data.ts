...
import type { BaseDataItem, MasterDataType } from '../types'

interface UseMasterDataResult<T extends BaseDataItem> {
  data: T[]
  isLoading: boolean
  error: string | null
...
export function useMasterData<T extends BaseDataItem>(
